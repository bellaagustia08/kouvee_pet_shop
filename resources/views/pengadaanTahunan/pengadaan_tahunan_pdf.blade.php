...
<head>
    <title>Cetak Laporan Pengeluaran Tahunan Kouvee Pet Shop</title>
...
<body>
    <table class='table table-bordered' style="border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            <td colspan="3">
                <font size="6">
                    <center><strong>LAPORAN PENGADAAN PRODUK TAHUNAN</strong></center>
                </font><br>
                <left>
                ...
                <table class='table table-bordered' style="border: 1px solid black; border-collapse: collapse;" cellspacing="0" width='250px' align="center">
                    <thead align="left">
                        <tr>
                            ...
                            <th class="tabledetail">Jumlah Pengeluaran</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            @elseif($pt != NULL)
                                <td class="tabledetail">Rp. {{$pt->total}}</td>
                            @endif
                        </tr>
                        @endforeach
                        <tr>
