...
<head>
    <title>Cetak Laporan Layanan Terlaris Kouvee Pet Shop</title>
...
<body>
    <table class='table table-bordered' style="border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            <td colspan="3">
                <font size="6">
                    <center><strong>LAPORAN LAYANAN TERLARIS</strong></center>
                </font>
            </td>
        </tr>
        <tr>
                ...
                <table class='table table-bordered' style="border: 1px solid black; border-collapse: collapse;" cellspacing="0" width='610px' align="center">
                    <thead align="left">
                        <tr>
                            ...
                            <th class="tabledetail">Nama Layanan</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @elseif($t != NULL)
                                <td class="tabledetail">{{$t->nama_layanan}} {{$t->nama_jenis}} {{$t->nama_ukuran}}</td>
                                <td class="tabledetail">
