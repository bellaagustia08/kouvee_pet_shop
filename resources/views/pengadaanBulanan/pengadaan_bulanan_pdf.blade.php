...
<head>
    <title>Cetak Laporan Pengadaan Bulanan Kouvee Pet Shop</title>
...
<body>
    <table class='table table-bordered' style="border: 1px solid black; border-collapse: collapse;">
        ...
        <tr>
            <td colspan="3">
                <font size="6">
                    <center><strong>LAPORAN PENGADAAN BULANAN</strong></center>
                </font><br>
                <left>
                ...
                <table class='table table-bordered' style="border: 1px solid black; border-collapse: collapse;" cellspacing="0" width='250px' align="center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @elseif($pb != NULL)
                                <td class="tabledetail">{{$pb->nama_produk}}</td>
                                <td class="tabledetail">
                                    <center>Rp. {{$pb->total}}</center>
                                </td>
                            @endif
                        </tr>
                        @endforeach
                        <tr>
                            <td colspan="3" align="right">
                                <font size="2">Total Rp. {{$subtotalsebulan->subtotal}}</font>
                            </td>
                        </tr>
                    </tbody>
                </table>
